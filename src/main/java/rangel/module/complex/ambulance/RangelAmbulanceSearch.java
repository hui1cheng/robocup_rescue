...
public class RangelAmbulanceSearch extends Search {
    ...
    /**
     * {@link RangelAmbulanceSearch}的构造函数
     *
     ...
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
    public RangelAmbulanceSearch(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.clustering = moduleManager.getModule("RangelAmbulanceSearch.Clustering", "adf.impl.module.algorithm.KMeansClustering");
        this.immovableHuman = moduleManager.getModule("RangelAmbulanceSearch.ImmovableHuman");
        this.blockedHuman = moduleManager.getModule("RangelAmbulanceSearch.BlockedHuman");
     ...
     *     <li>先从掩埋着市民的建筑中选择一个最近的作为搜索目标
     *     <li>如果步骤1取得的值为null,则从责任区内未搜索过的建筑物选取优先级最高的一个作为搜索目标
     * </ol>
     *
     * @return this
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
    ...
    public Search calc() {
        ...
        //从掩埋着市民的建筑中选择一个最近的作为搜索目标
        this.result = selectTargetFromBuriedCivilianBuildings();
        if (this.result != null) {
            return this;
        }

        //从未搜索过的建筑中选择一个最近的作为搜索目标
        this.result = this.selectTargetFromUnSearchedBuildings();
        return this;
    }
    ...
    private void updateUnSearchedBuildingMap() {
        ...
        buildings.forEach(buildingEntityID -> this.unSearchedBuildingMap.computeIfAbsent(buildingEntityID, k -> new HashSet<>()).addAll(civilians));
    ...
    /**
     * 从掩埋市民的建筑中选择一个建筑作为目标建筑
     *
     * @return 目标建筑的EntityID
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
    private EntityID selectTargetFromBuriedCivilianBuildings() {
        return this.result = this.buriedCivilianBuildingMap.keySet()
                .stream()
    ...
    /**
     * 从未搜索的建筑({@link #unSearchedBuildingMap})中选择一个建筑作为目标
     *
     * @return 目标建筑的EntityID
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
