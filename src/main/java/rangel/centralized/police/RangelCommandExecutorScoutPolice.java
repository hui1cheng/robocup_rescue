 ...
 */
public class RangelCommandExecutorScoutPolice extends CommandExecutor<CommandScout> {
    ...
    /**
     * {@link RangelCommandExecutorScoutPolice}的构造函数
     *
     ...
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
    public RangelCommandExecutorScoutPolice(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.pathPlanning = moduleManager.getModule("RangelCommandExecutorScoutPolice.PathPlanning", "adf.impl.module.algorithm.DijkstraPathPlanning");
        this.actionExtClear = moduleManager.getExtAction("RangelCommandExecutorScoutPolice.ExtActionClear", "adf.impl.extaction.DefaultExtActionClear");
    }
    ...
    public CommandExecutor<CommandScout> calc() {
        ...
        if (this.commandType == ACTION_SCOUT) {
            ...
            List<EntityID> path = this.pathPlanning
                    ...
                    .getResult();
            if (path != null) {
                EntityID targetID = path.size() > 0 ? path.get(path.size() - 1) : positionID;
