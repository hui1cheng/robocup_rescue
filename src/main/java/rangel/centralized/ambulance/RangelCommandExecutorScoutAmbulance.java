...
public class RangelCommandExecutorScoutAmbulance extends CommandExecutor<CommandScout> {
    ...
    /**
     * {@link RangelCommandExecutorScoutAmbulance}的构造函数
     *
     ...
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
    public RangelCommandExecutorScoutAmbulance(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
