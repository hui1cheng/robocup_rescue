...
public class RangelCommandPickerFire extends CommandPicker {
    ...
    /**
     * {@link RangelCommandPickerFire}的构造函数
     *
     ...
     * @author <a href="mailto:me@kinnrai.com">Kinnrai</a>
     */
    public RangelCommandPickerFire(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
