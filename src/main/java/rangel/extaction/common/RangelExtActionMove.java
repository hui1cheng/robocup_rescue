package rangel.extaction.common;
 ...
 */
public class RangelExtActionMove extends ExtAction {
    ...
    /**
     * {@link RangelExtActionMove}的构造函数
     *
    ...
    public RangelExtActionMove(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.targetID = null;
        this.thresholdRest = ConfigUtils.getInteger("thresholdRest.move", 100);
        this.pathPlanning = moduleManager.getModule("RangelExtActionMove.PathPlanning", "adf.impl.module.algorithm.DijkstraPathPlanning");
    }
    ...
    public ExtAction calc() {
        ...
        if (this.needRest(agent)) {
            this.result = this.calcRest(agent, this.pathPlanning, this.targetID);
            if (this.result != null) {
                return this;
            }
        }
